...
bioagents supports pluggable swarm policies. The current `default` policy preserves today’s behavior, and `ant`, `bee`, and `immune` are reserved for future variants.
